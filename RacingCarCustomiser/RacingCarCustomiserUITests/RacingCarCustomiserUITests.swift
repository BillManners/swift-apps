...
class RacingCarCustomiserUITests: XCTestCase {
    ...
    func testWhenBoughtExhaustandEngineCantBuyTires() {
        // UI tests must launch the application that they test.
        let app = XCUIApplication()
        app.launch()
        
        //act
        app.switches["engineAndExhaust"].tap()
        app.switches["tires"].tap()
        let testResult = app.switches["tires"].isSelected
        //assert
        XCTAssert(testResult == false)
